...
def run_test_harness():
    ...
    # prepare iterators
    train_it = train_datagen.flow_from_directory('dataset_all_x/dataset_cancer_vs_normal/train/',
                                                 class_mode='binary', batch_size=64, target_size=(200, 200))
    test_it = test_datagen.flow_from_directory('dataset_all_x/dataset_cancer_vs_normal/test/',
                                               class_mode='binary', batch_size=64, target_size=(200, 200))
    # fit model
    ...
    print('> %.3f' % (acc * 100.0))
    model.save('./colon_model_4_b_dropout_and_data_aug')
    # learning curves
